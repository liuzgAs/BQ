 ...
 */
public class GongXiangViewHolder extends BaseViewHolder<UserGetmyshare.DataBean> {
    ...
    public GongXiangViewHolder(ViewGroup parent, @LayoutRes int res) {
        super(parent, res);
    ...
    @Override
    public void setData(UserGetmyshare.DataBean data) {
        super.setData(data);
